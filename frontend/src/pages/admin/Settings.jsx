    ...
    <>
      ...
      <div className="dash-grid">
        <div className="card-widget">
          ...
          <div className="form-group"><label>Company Name</label><input defaultValue="Velura Events" /></div>
          <div className="form-group"><label>Contact Email</label><input defaultValue="hello@velura.ph" /></div>
        ...
        <div className="card-widget">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {['New booking notifications', 'Payment upload alerts', 'Client messages', 'Weekly reports'].map((label, i) => (
